...
export class Backend implements backendInterface {
    ...
    async searchContactMessages(arg0: string): Promise<Array<ContactMessage>> {
        if (this.processError) {
            try {
                const result = await this.actor.searchContactMessages(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateProduct(arg0: bigint, arg1: string, arg2: string, arg3: number, arg4: bigint, arg5: string, arg6: string): Promise<void> {
        if (this.processError) {
            try {
